...
local Window = OrionLib:MakeWindow({Name = "ACUM脚本", HidePremium = false, SaveConfig = true,IntroText = "ACUM脚本", ConfigFolder = "ACUM脚本"})

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "ACUM脚本"; Text ="欢迎使用ACUM脚本"; Duration = 4; })
...
about:AddParagraph("作者: qwrtui114587")
about:AddParagraph("作者qq: 3871593329")
...
Tab:AddButton({
	...
	Callback = function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/fcsdsss/westboundscp/refs/heads/main/2.0/ragebotMoblie"))()
	end
})
...
Tab:AddButton({
	...
	Callback = function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/fcsdsss/westboundscp/refs/heads/main/simpleToDoMobileS.lua"))()
	end
})
